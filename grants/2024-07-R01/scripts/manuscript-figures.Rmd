...
# ggsave("../figures/volcanic-range_mouseexp.svg", height = 3, width = 3)
```
...
ggsave("../figures/umap_facet-vatlike.png", height = 4, width = 6.5)
...
bind_rows(tmpsplit, tmpsol) %>%
  ...
  theme(text = element_text(size = 8),
        axis.text.x = element_text(angle = 45, hjust = 1))
ggsave("../figures/umap_facet-vatlike_legend.png", height = 4, width = 6.5)
```
