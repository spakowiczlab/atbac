...
ggsave("../figures/umap_facet-vatlike.png", height = 2, width = 4)
...
bind_rows(tmpsplit, tmpsol) %>%
  ...
  labs(x = "UMAP 1", y = "UMAP 2") +
  scale_color_viridis(direction = -1, name = "VATn\nScore") +
  theme_bw()  +
  theme(text = element_text(size = 10),
        axis.text.x = element_text(angle = 45, hjust = 1))
ggsave("../figures/umap_facet-vatlike_legend.png", height = 2, width = 5.5)
```
