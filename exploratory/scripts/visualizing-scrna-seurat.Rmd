...
cellmarker <- read.delim("../data/Human_cell_markers.txt")
```
...
scrna.sig.score <- calculateAvgZScore(scrna.frmt, neutmarkers) %>%
  ...
  left_join(scrna.data[c('Sample', 'Cell Type', 'umap_1', 'umap_2')], by = "Sample")
```
...
ggsave("../figures/umap-scrna-vat-neut-score.png", height = 5, width = 7.5)
```
