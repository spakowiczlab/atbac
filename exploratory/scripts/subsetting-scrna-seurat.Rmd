...
##load data
```{r}
scrna <- readRDS("/fs/ess/PAS1695/projects/atbac/data/refquery_final.rds")
```
...
##write csv
```{r}
saveRDS(scrna.subset, file = "/fs/ess/PAS1695/projects/atbac/data/scrna-seurat-subset.RDS")
```
